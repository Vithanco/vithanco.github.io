    ...
    return {
        ...
        createExports: (instance) => {
            ...
            const exports = {
                ...
                mountEditor: function bjs_mountEditor(elementId) {
                    const elementIdBytes = textEncoder.encode(elementId);
                    const elementIdId = swift.memory.retain(elementIdBytes);
                    instance.exports.bjs_mountEditor(elementIdId, elementIdBytes.length);
                },
                editorRenderNow: function bjs_editorRenderNow() {
                    instance.exports.bjs_editorRenderNow();
                },
                editorLongPressFired: function bjs_editorLongPressFired() {
                    instance.exports.bjs_editorLongPressFired();
                },
                setEditorVGL: function bjs_setEditorVGL(text) {
                ...
                dotForLayout: function bjs_dotForLayout(graph) {
                    const graphBytes = textEncoder.encode(graph);
                    const graphId = swift.memory.retain(graphBytes);
                    instance.exports.bjs_dotForLayout(graphId, graphBytes.length);
                    const ret = tmpRetString;
                    tmpRetString = undefined;
                    return ret;
                },
                ...
                renderGraphDark: function bjs_renderGraphDark(graph) {
                    const graphBytes = textEncoder.encode(graph);
                    const graphId = swift.memory.retain(graphBytes);
                    instance.exports.bjs_renderGraphDark(graphId, graphBytes.length);
                    const ret = tmpRetString;
                    tmpRetString = undefined;
                    return ret;
                },
